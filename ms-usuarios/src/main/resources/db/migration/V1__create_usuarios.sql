-- Create users table if not exists (shares table with ms-auth)
...
VALUES 
    ('12345678-9', 'María González', 'maria@sgaf.cl', '$2a$12$tth3mVm26e.znMo7/7mnQ..XDvsFTXoJQdLLoQ0qI0xo9ysY.YLvO', 'PASAJERO', NULL, true),
    ('87654321-0', 'Carlos Rodríguez', 'carlos@sgaf.cl', '$2a$12$tth3mVm26e.znMo7/7mnQ..XDvsFTXoJQdLLoQ0qI0xo9ysY.YLvO', 'FUNCIONARIO', 'Los Libertadores', true),
